...
Generated: `2026-08-20T01:50:26.197351Z` · Health: **Healthy** · Schema: `1.0.0`

## Executive signal

- Throughput: **2,756.05 TPS**
- Average slot time: **0.42 seconds**
- Active / delinquent validators: **688 / 8**
- SOL price: **85.24 USD** (11.13 % over 24h)
- DeFi TVL: **5.20B USD** · DEX volume: **2.59B USD**

## Network

| Metric | Value | Provenance |
|---|---:|---|
| TPS | 2,756.05 TPS | live · Solana RPC · getRecentPerformanceSamples |
| Slot time | 0.42 seconds | live · Solana RPC · getRecentPerformanceSamples |
| Block height | 418.43M blocks | live · Solana RPC · getBlockHeight |
| Epoch | 1,019 | live · Solana RPC · getEpochInfo |
| Epoch progress | 39.99 % | live · Solana RPC · getEpochInfo |
...
| Metric | Value | Provenance |
|---|---:|---|
| SOL price | 85.24 USD | live · CoinGecko |
| DeFi TVL | 5.20B USD | live · DefiLlama |
| Stablecoin supply | 15.68B USD | live · DefiLlama Stablecoins |
| DEX volume · 24h | 2.59B USD | live · DefiLlama DEX |
| Application fees · 24h | 10.25M USD | live · DefiLlama Fees |
| Median priority fee | 0.00 micro-lamports/CU | derived · Solana RPC · getRecentPrioritizationFees |
| Daily active addresses | 614,936.50 addresses | derived · Solana Data · Allium, Artemis, Blockworks, Dune |
| Tokenized assets | 2.80B USD | curated · Solana Ecosystem Roundup · May 2026 |

## Alerts

- **WATCH · SOL price — 11.1% / 24h**: SOL moved beyond the configured daily threshold. Rule: `|24h change| > 10%`
