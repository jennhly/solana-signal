...
Generated: `2026-09-26T11:22:20.882065Z` · Health: **Healthy** · Schema: `1.0.0`

## Executive signal

- Throughput: **1,612.10 TPS**
- Average slot time: **0.27 seconds**
- Active / delinquent validators: **676 / 11**
- SOL price: **120.57 USD** (-0.45 % over 24h)
- DeFi TVL: **6.58B USD** · DEX volume: **2.80B USD**

## Network

| Metric | Value | Provenance |
|---|---:|---|
| TPS | 1,612.10 TPS | live · Solana RPC · getRecentPerformanceSamples |
| Slot time | 0.27 seconds | live · Solana RPC · getRecentPerformanceSamples |
| Block height | 428.70M blocks | live · Solana RPC · getBlockHeight |
| Epoch | 1,043 | live · Solana RPC · getEpochInfo |
| Epoch progress | 19.39 % | live · Solana RPC · getEpochInfo |
...
| Metric | Value | Provenance |
|---|---:|---|
| SOL price | 120.57 USD | live · CoinGecko |
| DeFi TVL | 6.58B USD | live · DefiLlama |
| Stablecoin supply | 17.68B USD | live · DefiLlama Stablecoins |
| DEX volume · 24h | 2.80B USD | live · DefiLlama DEX |
| Application fees · 24h | 15.47M USD | live · DefiLlama Fees |
