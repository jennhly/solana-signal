...
Generated: `2026-09-22T11:35:25.053817Z` · Health: **Healthy** · Schema: `1.0.0`

## Executive signal

- Throughput: **1,585.12 TPS**
- Average slot time: **0.26 seconds**
- Active / delinquent validators: **674 / 15**
- SOL price: **116.96 USD** (0.46 % over 24h)
- DeFi TVL: **6.46B USD** · DEX volume: **3.51B USD**

## Network

| Metric | Value | Provenance |
|---|---:|---|
| TPS | 1,585.12 TPS | live · Solana RPC · getRecentPerformanceSamples |
| Slot time | 0.26 seconds | live · Solana RPC · getRecentPerformanceSamples |
| Block height | 427.41M blocks | live · Solana RPC · getBlockHeight |
| Epoch | 1,040 | live · Solana RPC · getEpochInfo |
| Epoch progress | 20.12 % | live · Solana RPC · getEpochInfo |
...
| Metric | Value | Provenance |
|---|---:|---|
| SOL price | 116.96 USD | live · CoinGecko |
| DeFi TVL | 6.46B USD | live · DefiLlama |
| Stablecoin supply | 15.79B USD | live · DefiLlama Stablecoins |
| DEX volume · 24h | 3.51B USD | live · DefiLlama DEX |
